...
class Config:
    ...
    def __init__(self):
        ...
        self.CLOUDFLARE_ACCOUNT_ID = data['CLOUDFLARE_ACCOUNT_ID']
        self.CLOUDFLARE_BUCKET_NAME = data['CLOUDFLARE_BUCKET_NAME']
        self.CLOUDFLARE_API_TOKEN = data['CLOUDFLARE_API_TOKEN']